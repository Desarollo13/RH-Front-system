...
const items = ref([
  { id: 1, name: 'Juan Pérez', email: 'juan@example.com', rol: 'administrador' },
  { id: 2, name: 'Ana Gómez', email: 'ana@example.com', rol: 'administrador', status: 1 },
  { id: 3, name: 'Carlos Ruiz', email: 'carlos@example.com', rol: 'administrador' },
  { id: 3, name: 'Janeth Fuentes', email: 'jan@example.com', rol: 'administrador', status: 1 },
]);
