  ...
  <CardContainer>
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-3 d-flex flex-column align-items-center">
        ...
        <img v-if="fotoPreview" :src="fotoPreview" alt="Foto Perfil" class="img-thumbnail" style="max-width: 150px;" />
      </div>
    </div>
...
const fields = ref([
  { label: 'Número Interior', model: 'numeroInterior', errorMessage: 'Número interior es requerido', status: ref('') },
  { label: 'Número Exterior', model: 'numeroExterior', errorMessage: 'Número exterior es requerido', status: ref('') },
  { label: 'Código Postal', model: 'codigoPostal', errorMessage: 'Código postal es requerido', status: ref('') },
  {
  ...
  { label: 'Referencia Cercana', model: 'referenciaCercana', errorMessage: 'Referencia cercana es requerida', status: ref('') },
])
