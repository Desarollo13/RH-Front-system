...
<template>
  <div class="container-fluid border rounded-9 shadow-sm my-3" style="background-color: rgba(0, 46, 109, 0.1);">
    <nav class="navbar navbar-expand-lg navbar-light px-4" style="background-color: #002e6d;">
      <div class="container-fluid">
        <!-- Botón para menú lateral -->
        <button class="btn btn-outline-light rounded-circle flex" @click="toggle">
          <i class="bi bi-list"></i>
        </button>

        <!-- Logo -->
        <a class="navbar-brand d-flex align-items-center" href="#">
          <img src="@/assets/logoNexen.png" alt="Logo" width="100" height="50" class="me-2" />
        </a>
        <!-- Separador flexible -->
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="me-3 d-flex align-items-center gap-2">
            ...
            <button class="btn btn-outline-light rounded-circle p-2 position-relative">
          ...
          <div class="dropdown">
            <button class="btn btn-outline-light dropdown-toggle d-flex align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="@/assets/avatar-1.jpg" alt="user" class="rounded-circle me-2" height="40" />
